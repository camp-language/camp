...
Define the behavioral requirements for string interpolation in Camp — the syntax, Display trait constraint, effect row propagation, raw and multiline string kinds, and nested brace handling.
