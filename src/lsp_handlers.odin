...
publish_diagnostics :: proc(server: ^LSP_Server, uri: string, diagnostics: [dynamic]LSP_Diagnostic) {
...
lsp_severity_to_int :: proc(s: LSP_DiagnosticSeverity) -> (int, bool) {
	switch s {
...
lsp_range_to_json :: proc(r: LSP_Range) -> json.Value {
